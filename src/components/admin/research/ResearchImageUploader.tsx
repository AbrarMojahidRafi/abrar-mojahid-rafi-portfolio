...
import { RESEARCH_MEDIA_BUCKET } from "@/lib/storage/research-media";

type ResearchImageUploaderProps = {
    label: string;
...
export default function ResearchImageUploader({
    label,
    value,
    onChange,
    onUploaded,
    onDiscard,
}: ResearchImageUploaderProps) {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            ...
            const filePath = `research/images/${crypto.randomUUID()}.${extension}`;
    ...
    return (
        <div>
            ...
            <input
                ...
                placeholder="/images/research/example.png"
                className="
                    mt-3
                    w-full
                    rounded-2xl
